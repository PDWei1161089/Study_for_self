...
class VGG16(nn.Module):
    ...
    def __init__(self):
        ...
        self.fc1 = nn.Linear(512 * 7 * 7, 4096)  # 全连接网络，输出通道为4096
        self.fc2 = nn.Linear(4096, 4096)  # 全连接网络，输出通道为4096
        self.fc3 = nn.Linear(4096, 1000)  # 全连接网络，输出通道为1000
        # softmax 1 * 1 * 1000
    ...
    def forward(self, x):  # 定义前向传播函数
        ...
        out = self.fc1(out)  # 4096
        out = F.relu(out)
        out = self.fc2(out)  # 4096
        out = F.relu(out)
        out = self.fc3(out)  # 1000
