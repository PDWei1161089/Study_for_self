...
pygame.display.set_caption("飞机大战 -- P.D. Wei Demo")
...
def main():
    ...
    while running:
            ...
            for each in big_enemies:
                if each.active:
                    ...
                    if not (delay % 3):
                        ...
                        screen.blit(each.destory_images[e3_destroy_index], each.rect)
                        e3_destory_index = (e3_destroy_index + 1) % 6
                        if e3_destroy_index == 0:
            ...
            for each in mid_enemies:
                if each.active:
                    ...
                    if not (delay % 3):
                        ...
                        screen.blit(each.destory_images[e2_destroy_index], each.rect)
        ...
        # 绘制游戏结束画面
            ...
            # 绘制结束画面
            record_score_text = score_font.render(f"Best : {record_score}", True, (255, 255, 255))
